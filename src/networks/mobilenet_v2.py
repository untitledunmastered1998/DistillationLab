...
from src.networks.misc import ConvNormActivation
from src.networks._utils import _make_divisible
...
model_urls = {
    'mobilenet': 'https://download.pytorch.org/models/mobilenet-b0353104.pth',
}
